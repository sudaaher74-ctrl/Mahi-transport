    ...
    >
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <div className="pt-3 pb-2.5 px-3 flex items-center justify-between">
            {/* Logo on Left */}
            ...
            <div className="flex-1 text-center px-2">
              <h1 
                className="text-[28px] leading-none font-black uppercase tracking-wider mb-1"
                style={{
              ...
              <div 
                className="text-[12px] font-black tracking-wider text-black mb-1 uppercase"
                style={{ fontFamily: '"Times New Roman", Times, serif' }}
              >
                {company.subtitle || 'FLEET OWENERS & TRANSPORT CONTRACTORS'}
              </div>
              
              <div className="text-[10.5px] font-normal text-black mb-0.5 leading-snug">
                {company.address}
              </div>
              
              <div className="text-[10.5px] font-normal text-black">
          ...
          >
            <span 
              className="font-bold text-[15px] tracking-[0.2em] text-black uppercase block"
              style={{ fontFamily: '"Times New Roman", Times, serif' }}
            >
              INVOICE
            </span>
          ...
          <div className="grid grid-cols-12 border-b border-black text-[11.5px]">
            {/* Left Party Box */}
            <div className="col-span-8 p-2 px-2.5 border-r border-black flex flex-col justify-between min-h-[52px]">
          ...
          {/* 4. Main Particulars Table with Proportional Compact Height */}
          <div className="flex flex-col relative">
            {/* Table Header */}
            <div className="flex border-b border-black text-center font-bold text-[11px] bg-white">
              <div className="w-[11%] border-r border-black py-1.5 px-1 flex items-center justify-center">Date</div>
              <div className="w-[15%] border-r border-black py-1.5 px-1 flex items-center justify-center">Vehicle No.</div>
              <div className="w-[32%] border-r border-black py-1.5 px-1 flex items-center justify-center">Perticulars</div>
              <div className="w-[14%] border-r border-black py-1.5 px-1 flex items-center justify-center">Size</div>
              <div className="w-[9%] border-r border-black py-1.5 px-0.5 flex items-center justify-center">Advance</div>
              <div className="w-[9%] border-r border-black py-1.5 px-0.5 flex items-center justify-center">Charges</div>
            ...
            <div className="flex relative text-[11px] min-h-[250px] max-h-[320px]">
              {/* Column 1: Date */}
              <div className="w-[11%] border-r border-black py-2.5 px-1 text-center flex flex-col space-y-4 font-normal">
              ...
              {/* Column 2: Vehicle No */}
              <div className="w-[15%] border-r border-black py-2.5 px-1 text-center flex flex-col space-y-4 font-normal uppercase">
                {bill.items.map((item, idx) => (
              ...
              <div className="w-[32%] border-r border-black py-2.5 px-1 text-center flex flex-col space-y-4 font-normal uppercase">
                {bill.items.map((item, idx) => (
              ...
              {/* Column 4: Size */}
              <div className="w-[14%] border-r border-black py-2.5 px-1 text-center flex flex-col space-y-4 font-normal uppercase">
                {bill.items.map((item, idx) => (
              ...
              {/* Column 5: Advance */}
              <div className="w-[9%] border-r border-black py-2.5 px-0.5 text-center flex flex-col space-y-4 font-normal">
                {bill.items.map((item, idx) => (
              ...
              {/* Column 7: Amount */}
              <div className="w-[10%] border-r-0 py-2.5 px-1 text-right flex flex-col space-y-4 font-normal">
                {bill.items.map((item, idx) => (
        ...
        <div className="border-t border-black">
          ...
          <div className="grid grid-cols-12 border-b border-black text-[12px]">
            ...
            <div className="col-span-5 text-[12px]">
              <div className="grid grid-cols-12 border-b border-black py-1 px-2.5 items-center" style={{ backgroundColor: '#fde7da' }}>
              ...
              <div className="grid grid-cols-12 py-1 px-2.5 items-center" style={{ backgroundColor: '#fde7da' }}>
          ...
          <div className="grid grid-cols-12 text-[10.5px] min-h-[90px]">
            ...
            <div className="col-span-5 p-2 px-3 flex flex-col justify-between items-center text-center">
              ...
              <div 
                className="font-bold text-[12px] tracking-wide pb-1"
                style={{ fontFamily: '"Times New Roman", Times, serif' }}
              >
                Proprietor
              </div>
